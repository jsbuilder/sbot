 ...
 */
final class Version20240205194448 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE telegram_message (id BIGINT AUTO_INCREMENT NOT NULL, user BIGINT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, chat_id BIGINT NOT NULL, message_id BIGINT NOT NULL, callback VARCHAR(255) DEFAULT NULL, text VARCHAR(255) DEFAULT NULL, INDEX IDX_EDFB51898D93D649 (user), INDEX chat_message_idx (chat_id, message_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
